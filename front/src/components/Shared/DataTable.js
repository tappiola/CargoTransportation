...
function createData(id, name, email, company_name, company_unp) {
    return {id, name, email, company_name, company_unp};
}

console.log(`Raw data for table: ${rows}`);
